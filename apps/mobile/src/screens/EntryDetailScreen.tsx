/**
 * EntryDetailScreen — View a live entry's full content and storage info
 *
 * Shows entry content, metadata, all attachments (including deleted),
 * version history count, and total size breakdown.
 *
 * Navigation: Data Management > Entries > Entry Detail
 */
...
export function EntryDetailScreen() {
  ...
  const { data: entry, isLoading, error } = useEntryDetail(entryId);
  ...
  if (isLoading) {
    return (
      <View style={[styles.container, { backgroundColor: theme.colors.background.secondary }]}>
        <SecondaryHeader title="Entry Detail" />
