...
--
-- This adds category property fields to the categories table
-- ============================================================================
...
--
-- 3. Verify it worked:
--    npx supabase gen types typescript --project-id lsszorssvkavegobmqic | grep -A 2 "entry_title_template"
--    (You should see the new category property fields)
-- ============================================================================
